...
def limpiar_preparar_pdls(files):
    ...
    # se limpian y preparan los datos de salary_formality en la tabla de totalpopulation mysql
    ...
    # se limpian y preparan los datos de pop_desocupada en la tabla de unemployment mysql
    ...
    # se limpian y preparan los datos de pea_sex y desocupada_sex en la tabla de laboractivity mysql
